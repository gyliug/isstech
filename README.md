...
平台采用Spring Boot 2.X 、Spring Security、Oauth2、Mybatis Plus、Activiti、Flutter等核心技术，前端基于vue-element-admin框架。 参考项目：pig、ruoyi前端。演示地址：http://47.100.3.58/ **（请不要更改用户entfrm的密码，谢谢！）** **满 500 Star更新已完成的所有功能**
